...
void get_matrix_from_data(int ***sources_matrix, int ***targets_matrix, int *num_sentences, const int iterations, const char *sources_iter_file_name, const char *targets_iter_file_name, const char *sources_vocab_file_name, const char *targets_vocab_file_name, const char *corpus_file_name, const char *sources_matrix_file_name, const char *targets_matrix_file_name, int save)
{
    ...
    if (iter_file_ptr != NULL)
    {
        ...
        {
            load_sentence_matrix(sources_matrix, num_sentences, sources_matrix_file_name);
            load_sentence_matrix(targets_matrix, num_sentences, targets_matrix_file_name);
        } else
        {
            ...
            save_sentence_matrix((const int **) *sources_matrix, *num_sentences, sources_matrix_file_name);
            save_sentence_matrix((const int **) *targets_matrix, *num_sentences, targets_matrix_file_name);
        }
    }
}
