...
void save_sentence_matrix(const int **sentences_vectors, const int num_sentences, const char *file_name)
{
    if (sentences_vectors == NULL || num_sentences <= 0 || file_name == NULL)
    {
        return;
    }
